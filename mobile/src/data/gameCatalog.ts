...
export const GAME_CATALOG: Record<GameId, GameCatalogEntry> = {
  ...
  FlashReading: {
    ...
    difficulty: {
      easy: option('Easy', '272 common words · starts at 120 WPM'),
      medium: option('Medium', '230 longer words · starts at 220 WPM'),
      hard: option('Hard', '307 advanced words · 320 WPM · lower area masked'),
    },
  ...
  WordsRecall: {
    ...
    difficulty: {
      easy: option('Easy', '120 prompts from 272 common words · 1.6-second display'),
      medium: option('Medium', '120 prompts from 230 intermediate words · 1.1-second display'),
      hard: option('Hard', '120 prompts from 307 advanced words · 0.7-second display'),
    },
  ...
  SentenceRecall: {
    ...
    difficulty: {
      easy: option('Easy', '240 of 5,832 simple combinations · 2.2-second display'),
      medium: option('Medium', '240 of 5,832 longer combinations · 1.6-second display'),
      hard: option('Hard', '240 of 5,832 complex combinations · 1.1-second display'),
    },
  ...
  VisualSpanExpansion: {
    ...
    difficulty: {
      easy: option('Easy', '3 positions · 71 equal-length words · 1600 ms'),
      medium: option('Medium', '5 positions · 194 equal-length words · 1200 ms'),
      hard: option('Hard', '7 positions · 75 equal-length words · 850 ms'),
    },
  ...
  TimedWordRecognition: {
    ...
    difficulty: {
      easy: option('Easy', '272 common words · starts at 120 WPM'),
      medium: option('Medium', '230 academic words · starts at 220 WPM'),
      hard: option('Hard', '307 advanced words · starts at 320 WPM'),
    },
  ...
  TimedPhraseRecognition: {
    ...
    difficulty: {
      easy: option('Easy', '240 of 5,832 simple phrases · starts at 180 WPM'),
      medium: option('Medium', '240 of 5,832 longer phrases · starts at 260 WPM'),
      hard: option('Hard', '240 of 5,832 complex phrases · starts at 360 WPM'),
    },
  ...
  LastWordRecall: {
    ...
    difficulty: {
      easy: option('Easy', '272 common words · starts at 180 WPM'),
      medium: option('Medium', '230 academic words · starts at 280 WPM'),
      hard: option('Hard', '307 advanced words · starts at 380 WPM'),
    },
  ...
  WordPairs: {
    ...
    difficulty: {
      easy: option('Easy', '30 reviewed pairs · 45-second session'),
      medium: option('Medium', '30 reviewed pairs · 30-second session'),
      hard: option('Hard', '31 reviewed pairs · 20-second session'),
    },
  ...
  TextSearch: {
    ...
    difficulty: {
      easy: option('Easy', '12 short passages · no limit · count visible'),
      medium: option('Medium', '12 longer passages · 30 seconds · count visible'),
      hard: option('Hard', '12 dense passages · 20 seconds · count hidden'),
    },
  ...
  WordSearchGame: {
    ...
    difficulty: {
      easy: option('Easy', '4 × 4 · 101 targets · forward directions · 90 seconds'),
      medium: option('Medium', '5 × 5 · 313 targets · orthogonal directions · 60 seconds'),
      hard: option('Hard', '6 × 6 · 178 targets · all directions · 45 seconds'),
    },
  ...
  LetterJumble: {
    ...
    difficulty: {
      easy: option('Easy', '32 common words · obvious transposition'),
      medium: option('Medium', '32 mid-length words · internal transposition'),
      hard: option('Hard', '32 advanced words · subtle transposition'),
    },
