...
const styles = StyleSheet.create({
  ...
  targetHighlight: { color: '#0E4979', fontWeight: '700' },
  startBtn: { backgroundColor: '#0E4979', paddingVertical: 12, borderRadius: 8, alignItems: 'center' },
  ...
  statValue: { fontSize: 18, fontWeight: '700', color: '#083B65' },
  ...
  symbol: { fontSize: 64, fontWeight: '800', color: '#083B65' },
