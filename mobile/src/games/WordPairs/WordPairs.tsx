...
const styles = StyleSheet.create({
  ...
  statBox: { alignItems: 'center', backgroundColor: colors.background, paddingVertical: 6, paddingHorizontal: 14, borderRadius: 8 },
  ...
  correctText: { color: colors.successForeground, fontSize: 12, fontWeight: '700', marginTop: 6 },
  wrongText: { color: colors.errorForeground, fontSize: 12, fontWeight: '700', marginTop: 6 },
  wordLabel: { fontSize: 12, color: colors.primary, marginBottom: 4 },
  word: { fontSize: 24, fontWeight: '700', color: colors.primaryDark },
  ...
  endScore: { fontSize: 32, fontWeight: '800', color: colors.primary, marginVertical: 8 },
