...
const styles = StyleSheet.create({
  ...
  timerBox: { backgroundColor: colors.infoSurface },
  ...
  targetLabel: { fontSize: 12, color: colors.secondary },
  targetLetter: { fontSize: 36, fontWeight: '800', color: colors.primary },
  targetHint: { fontSize: 10, color: colors.secondary },
