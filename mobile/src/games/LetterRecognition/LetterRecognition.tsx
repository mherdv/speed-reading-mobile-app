...
const styles = StyleSheet.create({
  ...
  statBox: { alignItems: 'center', backgroundColor: '#E7F5FB', paddingVertical: 6, paddingHorizontal: 12, borderRadius: 8 },
  timerBox: { backgroundColor: '#CDEAF5' },
  statValue: { fontSize: 16, fontWeight: '700', color: '#0E4979' },
  ...
  targetLabel: { fontSize: 12, color: '#0B628F' },
  targetLetter: { fontSize: 36, fontWeight: '800', color: '#0E4979' },
  targetHint: { fontSize: 10, color: '#0B628F' },
