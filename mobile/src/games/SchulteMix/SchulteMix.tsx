      ...
      {phase === 'running' && (
        <View style={styles.gameArea}>
          <View style={styles.statsRow}>
            <View style={[styles.statBox, nextCell?.type === 'number' ? styles.numberBox : styles.letterBox]}>
              <Text style={styles.statValue}>{nextCell?.value}</Text>
              <Text style={styles.statLabel}>Next ({nextCell?.type === 'number' ? '#' : 'A'})</Text>
            </View>
