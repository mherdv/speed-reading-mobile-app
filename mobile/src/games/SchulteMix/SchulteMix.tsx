...
const styles = StyleSheet.create({
  ...
  statBox: { alignItems: 'center', backgroundColor: colors.surfaceTonal, paddingVertical: 6, paddingHorizontal: 12, borderRadius: 8 },
  numberBox: { backgroundColor: colors.infoSurface },
  letterBox: { backgroundColor: colors.warningSurface },
  statValue: { fontSize: 16, fontWeight: '700', color: colors.primary },
  errorValue: { color: colors.errorForeground },
  ...
  cellNumber: { backgroundColor: colors.infoSurface, borderColor: colors.border },
  cellLetter: { backgroundColor: colors.warningSurface, borderColor: colors.warningSurface },
  ...
  endTime: { fontSize: 32, fontWeight: '800', color: colors.primary, marginVertical: 8 },
