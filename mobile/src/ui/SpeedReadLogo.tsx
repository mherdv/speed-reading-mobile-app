...
export function SpeedReadLogo({ size = 32 }: Props) {
  return (
    <Svg width={size} height={size} viewBox="0 0 100 100" fill="none">
      {/* Speed Lines */}
      <Path d="M5 35H25M5 50H20M5 65H25" stroke={colors.brandCyan} strokeWidth="6" strokeLinecap="round" />
      ...
      {/* Top Gauge/Needle */}
      <Circle cx="60" cy="20" r="12" stroke={colors.brandNavy} strokeWidth="3" fill="#FFF" />
      <Path d="M60 20L68 12" stroke={colors.brandCyan} strokeWidth="3" strokeLinecap="round" />
    </Svg>
  );
}
